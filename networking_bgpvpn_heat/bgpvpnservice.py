...
#from heat.engine.clients.os.neutron import NeutronConstraint
...
# (see setup.cfg)
#class BGPVPNConstraint(NeutronConstraint):
class BGPVPNConstraint():
...
class BGPVPNNetAssoc(neutron.NeutronResource):
    ...
    def handle_create(self):
        ...
        bgpvpn_id = self.client_plugin().find_neutron_resource(
            props, self.BGPVPN_ID, 'bgpvpn')
